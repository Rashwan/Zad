...
public class ChooseCategoryPage extends SingleFixedChoicePage {
	public ChooseCategoryPage(ModelCallbacks callbacks, String title) {
		super(callbacks, title);
	}

	@Override
	public Fragment createFragment() {
		return ChooseCategory.create(getKey());
	}
