...
import static com.app.zad.ui.CategoriesFragment.CATEGORY_SHARED_ELEMENT_NAME;
...
public class CategoriesListQuotesNotBoring extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cat_intent.hasExtra(CATEGORY_SHARED_ELEMENT_NAME)){
            catSharedElement = cat_intent.getExtras().getString(CATEGORY_SHARED_ELEMENT_NAME);
